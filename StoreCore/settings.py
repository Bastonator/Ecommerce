"""
Django settings for StoreCore project.
...
SECRET_KEY = 'django-insecure-xi#m8)hyni=viksoo-x+9lc5$&4klutf&t5^bh*(ox!a29^g9g'
...
WSGI_APPLICATION = 'StoreCore.wsgi.application'
